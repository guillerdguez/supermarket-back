...
import com.supermercado.supermercado.controller.ProductController;
...
class ProductControllerTest {
    ...
    void getAll_ShouldReturnList() throws Exception {
        given(productService.getAll()).willReturn(List.of(TestFixtures.productResponse()));
    ...
    void getById_ShouldReturnProduct() throws Exception {
        ...
        mockMvc.perform(get("/products/1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.nombre").value("Premium Rice"));
    }
    ...
    void create_ShouldReturn201() throws Exception {
        ...
        given(productService.create(any(ProductoRequest.class))).willReturn(response);
    ...
    void update_ShouldReturnUpdatedProduct() throws Exception {
        ProductoResponse response = TestFixtures.productResponse();
        given(productService.update(eq(1L), any(ProductoRequest.class))).willReturn(response);
