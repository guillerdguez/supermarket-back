...
class ProductServiceTest {
    ...
    @Test
    @DisplayName("GET LOW STOCK - should return products with stock less than amount")
    void getLowStockProducts_ShouldReturnLowStockProducts() {
        Product lowStockProduct = TestFixtures.productWithIdAndStock(3L, 5);
        Product normalProduct = TestFixtures.productWithIdAndStock(4L, 50);
        List<Product> lowStockProducts = List.of(lowStockProduct);
        ProductResponse lowStockResponse = ProductResponse.builder()
                .id(3L)
                .name("Premium Rice")
                .category("Food")
    ...
    @Test
    @DisplayName("GET LOW STOCK - should return multiple low stock products")
    void getLowStockProducts_WithMultipleLowStock_ShouldReturnAll() {
        Product product1 = TestFixtures.productWithIdAndStock(1L, 2);
    ...
    @Test
    @DisplayName("GET LOW STOCK - should handle zero threshold")
    void getLowStockProducts_WithZeroThreshold_ShouldReturnProductsWithZeroStock() {
        Product zeroStockProduct = TestFixtures.productWithIdAndStock(1L, 0);
